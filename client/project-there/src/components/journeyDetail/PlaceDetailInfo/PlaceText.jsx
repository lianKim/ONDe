...
const StyeldTextHolder = styled.p`
  ...
  height: ${(props) =>
    props.displayOverFlowed
      ? '58%'
      : conditionalChain(props.overflowed, '20%', '23%')};
  ...
  border-bottom: ${(props) => !props.overflowed && '0.5px solid #bcc4c6'};
`;
...
export default function PlaceText({ text, controlOverflow, controlDisplay }) {
  ...
  return (
    <>
      ...
      {!!isOverflowed && (
        <StyledTextSeeMore onClick={handleContentClick}>
